module FluentIcons
  class Fluent
    attr_reader :options, :width, :height, :symbol, :keywords, :weight, :style, :prefix
  ...
  private
    ...
    def classes
      @classes ||= "#{ prefix } #{ prefix }-#{ symbol } #{ options[:class] } ".strip
    end
